...
import ru.danilarassokhin.game.config.ResilienceConfig;
import ru.danilarassokhin.game.server.GameServer;

public class GameApplication {

  public static void main(String[] args) {
    GameServer.start(ApplicationConfig.class, CacheConfig.class, ResilienceConfig.class,
                     ComponentsConfig.class, DataSourceConfig.class, CamundaConfig.class,
                     HttpConfig.class);
  }
