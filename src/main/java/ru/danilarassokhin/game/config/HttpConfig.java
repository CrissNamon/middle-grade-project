...
public class HttpConfig {
  ...
  @GameBean(order = 3)
  public DispatcherController dispatcherController(HttpHandlerProcessor httpHandlerProcessor, PlayerController playerController, GlobalExceptionHandler globalExceptionHandler) {
    return new ReflectiveDispatcherController(httpHandlerProcessor, playerController, globalExceptionHandler);
  }
