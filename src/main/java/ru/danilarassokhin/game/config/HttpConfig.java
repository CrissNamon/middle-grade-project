...
public class HttpConfig {
  ...
  @GameBean(order = 3)
  public DispatcherController dispatcherController(HttpHandlerProcessor httpHandlerProcessor, GlobalExceptionHandler globalExceptionHandler, PlayerController playerController) {
