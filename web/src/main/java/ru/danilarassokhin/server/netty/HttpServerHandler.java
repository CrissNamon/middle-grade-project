...
import static ru.danilarassokhin.server.netty.NettyServer.HTTP_VERSION;
import static ru.danilarassokhin.server.util.HttpUtils.createByteBufFromString;
import static ru.danilarassokhin.server.util.HttpUtils.createInternalServerError;
