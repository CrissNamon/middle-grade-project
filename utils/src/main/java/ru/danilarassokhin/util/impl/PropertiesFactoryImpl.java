package ru.danilarassokhin.util.impl;
...
import ru.danilarassokhin.util.exception.PropertiesException;
...
public class PropertiesFactoryImpl implements PropertiesFactory {
  ...
  public PropertiesFactoryImpl() {
    try {
      ...
      throw new PropertiesException("Failed to load properties file", e);
    }
  }
